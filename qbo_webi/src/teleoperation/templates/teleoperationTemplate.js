...
//liniear = forward/back
//angular = left/right
var LINEAR_SPEED = 0.2;
...
*/
    jQuery("#video_size_select").change(function() {
        ...
        jQuery("#iframeTeleoperation").attr("width",value*640);
        jQuery("#iframeTeleoperation").attr("height",value*480);
        jQuery("#imgInvisible").attr("width",value*640);
        jQuery("#imgInvisible").attr("height",value*480);  
  ...
  //      jQuery("#first_table_first_row").attr("style","height:"+value*240+"px;"); 
        ...
        input = {"width": value*640, "height":value*480};
...
*/
   ...
   jQuery("#neutral").click(function(){
            ...
            jQuery.post('/teleoperation/expressions',input,function(data) {
	   });
    });
   ...
   jQuery("#mad").click(function(){
            input = {expression: "mad"};
            jQuery.post('/teleoperation/expressions',input,function(data) {
           });
    });
      
   jQuery("#curious").click(function(){
            input = {expression: "curious"};
            jQuery.post('/teleoperation/expressions',input,function(data) {
           });
    });
      
   jQuery("#straight").click(function(){
            input = {expression: "straight"};
            jQuery.post('/teleoperation/expressions',input,function(data) {
           });
    });
         
   jQuery("#smile").click(function(){
            input = {expression: "smile"};
            jQuery.post('/teleoperation/expressions',input,function(data) {
           });
    }); 

   jQuery("#suspicious").click(function(){
            input = {expression: "suspicious"};
            jQuery.post('/teleoperation/expressions',input,function(data) {
           });
    });
	...
	for (var i in keys) {
	 ...
	 var time_now = d.getTime();
         var time_diff = time_now-last_time_pressed;
          ...
          if (keypressed.indexOf("38") != -1  && keypressed.indexOf("37") != -1 && !textAreaFocused  ) {                
          ...
          }else if (keypressed.indexOf("38") != -1  && keypressed.indexOf("39") != -1  && !textAreaFocused ) {
          ...
          }else if (keypressed.indexOf("40") != -1  && keypressed.indexOf("37") != -1 && !textAreaFocused ) {
		 ...
		 last_time_pressed = time_now;
          ...
          }else if (keypressed.indexOf("40") != -1  && keypressed.indexOf("39") != -1 && !textAreaFocused ) {
          ...
          }else if (keypressed.indexOf("39") != -1 && !textAreaFocused ) {
          ...
          }else if (keypressed.indexOf("37") != -1  && !textAreaFocused) {
          ...
          }else if (keypressed.indexOf("38") != -1 && !textAreaFocused ) {
          ...
          }else if (keypressed.indexOf("40") != -1  && !textAreaFocused) {
