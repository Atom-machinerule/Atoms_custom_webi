...
class MjpegGrabber():
    ...
    @cherrypy.expose
    def stream(self,topic,quality='100',width='640',height='480',rate='30',t=''):
    ...
    @cherrypy.expose
    def snapshot(self,topic,quality='100',width='640',height='480',t=''):
        imageInfo={}
        imageInfo['topic']=topic
        imageInfo['quality']=int(quality)
        imageInfo['width']=int(width)
    ...
    @cherrypy.expose
    def stop(self,topic,quality='100',width='640',height='480',rate='30.0',t=''):
        imageInfo={}
        imageInfo['topic']=topic
        imageInfo['quality']=int(quality)
        imageInfo['width']=int(width)
